...
# Carrega variáveis do .env (funciona no Render se as variáveis forem setadas no painel)
load_dotenv()
...
frases_infectadas = [
    ...
    "O cheiro de sangue fresco não é atrativo por infectados. Você não está mais sozinho.",
...
gatilhos = [
    "infectado", "caçar", "algo", "grunhido", "sangue", "neblina", "grito", "passos",
    "som", "escuridão", "correr", "esconderijo", "zumbi", "rugido", "pavor", "sombra",
    "barulho", "rastejar", "eco", "arranhar", "batida", "pânico", "fedor", "desespero",
    "sussurro", "movimento", "estripar", "vítima", "respirar", "algo estranho", "arranhão"
]
